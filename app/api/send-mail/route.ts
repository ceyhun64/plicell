...
<div style="background: linear-gradient(135deg, #7B0323 0%, #C70039 100%); padding: 15px 28px; text-align: center; position: relative;">
 ...
 <div style="background: #ffffff; border-radius: 16px; padding: 16px; display: inline-block; margin-bottom: 16px; box-shadow: 0 8px 28px rgba(0,0,0,0.10); position: relative; z-index: 1;">
  ...
  <p style="margin: 8px 0 0 0; font-size: 14px; color: rgba(255,255,255,0.9); font-weight: 500; position: relative; z-index: 1;">
    Yaşam Alanlarınıza Şıklık Katan Dokunuşlar
      ...
      <div style="padding: 48px 40px;">
        ...
        <!-- Main Message -->
        <h2 style="color: #1a1a1a; font-size: 24px; margin: 0 0 16px 0; font-weight: 700; line-height: 1.3;">
          Yeni Bir İletişim Formu Mesajı Aldınız
        </h2>

        <p style="font-size: 15px; color: #666666; margin: 0 0 32px 0; line-height: 1.7;">
          Web siteniz üzerinden yeni bir mesaj gönderildi. Aşağıda mesajın detaylarını bulabilirsiniz.
        </p>

        <!-- Message Card -->
        <div style="background: linear-gradient(135deg, #f8f9fa 0%, #ffffff 100%); border: 2px solid #e9ecef; border-radius: 12px; padding: 28px; margin-bottom: 32px; position: relative; overflow: hidden;">
          <!-- Decorative Corner -->
          ...
          <div style="position: relative; z-index: 1;">
            <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 16px; padding-bottom: 16px; border-bottom: 2px solid #e9ecef;">
              <span style="font-size: 20px;">💬</span>
              <strong style="font-size: 15px; color: #7B0323; font-weight: 600;">Mesaj İçeriği</strong>
            </div>
            
            <div style="font-size: 15px; color: #333333; line-height: 1.8; white-space: pre-line;">
              ${message}
            </div>
          </div>
        </div>
      ...
      <div style="background: #f8f9fa; padding: 32px 40px; text-align: center; border-top: 1px solid #e9ecef;">
        ...
        <div style="margin-bottom: 20px;">
          <p style="margin: 0 0 12px 0; font-size: 16px; color: #1a1a1a; font-weight: 700;">
            Moda Perde
          </p>
        ...
        <div style="margin: 20px 0; padding: 20px 0; border-top: 1px solid #e9ecef; border-bottom: 1px solid #e9ecef;">
          <p style="margin: 0 0 12px 0; font-size: 13px; color: #999999; font-weight: 600;">
            BİZİ TAKİP EDİN
          </p>
        ...
        <!-- Legal Text -->
        <p style="margin: 12px 0 0 0; font-size: 12px; color: #999999; line-height: 1.5;">
