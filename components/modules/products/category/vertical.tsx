...
export default function Vertical() {
  ...
  return (
    <div className="max-w-8xl mx-auto mb-20">
      ...
      <div className="relative w-full h-[50vh] md:h-[70vh]  md:mb-12 overflow-hidden">
        ...
        <div className="relative h-full flex flex-col justify-end px-4 sm:px-6 md:px-12 lg:px-16 pb-8 sm:pb-12 md:pb-16 max-w-3xl md:max-w-7xl mx-auto">
          ...
          <p className="text-white/90 text-sm sm:text-base md:text-lg lg:text-xl max-w-full sm:max-w-2xl mb-6 sm:mb-8 leading-relaxed">
            Modern yaşam alanlarınız için özel tasarlanmış, yüksek kaliteli
            dikey perde koleksiyonumuzu keşfedin.
          </p>
      ...
      {/* Main Content */}
      <div className="bg-gradient-to-b from-amber-50/30 via-white to-amber-50/30 md:px-8">
          ...
          <main className="flex-1">
            ...
            <div className="mt-6 md:mt-8 px-2 md:px-0">
              {filteredProducts.length > 0 ? (
                ...
                <div className="p-12 md:p-16 text-center bg-white rounded-2xl border border-amber-100 shadow-lg">
                  ...
                  <p className="text-gray-500">
                    Bu filtrelere uygun ürün bulunmamaktadır. Lütfen filtreleri
